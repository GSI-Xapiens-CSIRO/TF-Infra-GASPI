...
| <a name="input_kms_key"></a> [kms\_key](#input\_kms\_key) | KMS Key References | `map(string)` | <pre>{<br/>  "default": "arn:aws:kms:ap-southeast-3:463470956521:key/HASH_KEY_NUMBER",<br/>  "lab": "arn:aws:kms:ap-southeast-3:463470956521:key/HASH_KEY_NUMBER",<br/>  "prod": "arn:aws:kms:ap-southeast-3:463470956521:key/HASH_KEY_NUMBER",<br/>  "staging": "arn:aws:kms:ap-southeast-3:463470956521:key/HASH_KEY_NUMBER"<br/>}</pre> | no |
