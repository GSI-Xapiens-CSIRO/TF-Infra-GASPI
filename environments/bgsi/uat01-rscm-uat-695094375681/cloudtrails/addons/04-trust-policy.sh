...
cat > trust-policy.json << 'EOF'
{
  ...
  "Statement": [
    ...
    },
    {
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:sts::480756163420:assumed-role/cp-sts-grant-role/swift-ap-southeast-3-prod-695094375681"
      },
      "Action": "sts:AssumeRole"
    },
    {
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::695094375681:root"
      },
      "Action": "sts:AssumeRole"
    }
  ]
  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:s3:::genomic-snapshot-695094375681"
    },
    {
      "Effect": "Allow",
      "Action": [
