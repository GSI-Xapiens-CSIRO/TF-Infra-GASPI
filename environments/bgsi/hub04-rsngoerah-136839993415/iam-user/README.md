# Terraform IAM User for 136839993415
...
| <a name="input_aws_account_id_destination"></a> [aws\_account\_id\_destination](#input\_aws\_account\_id\_destination) | The AWS Account ID to deploy the Budget in | `string` | `"136839993415"` | no |
| <a name="input_aws_account_id_source"></a> [aws\_account\_id\_source](#input\_aws\_account\_id\_source) | The AWS Account ID management | `string` | `"136839993415"` | no |
| <a name="input_aws_account_profile_destination"></a> [aws\_account\_profile\_destination](#input\_aws\_account\_profile\_destination) | The AWS Profile to deploy the Budget in | `string` | `"BGSI-TF-User-Executor-RSNGOERAH"` | no |
| <a name="input_aws_account_profile_source"></a> [aws\_account\_profile\_source](#input\_aws\_account\_profile\_source) | The AWS Profile management | `string` | `"BGSI-TF-User-Executor-RSNGOERAH"` | no |
...
| <a name="input_bgsi_team_administrator"></a> [bgsi\_team\_administrator](#input\_bgsi\_team\_administrator) | BGSI Administrator Team Member | `list(any)` | <pre>[<br/>  "bgsi.admin01@binomika.kemkes.go.id",<br/>  "bgsi.admin02@binomika.kemkes.go.id"<br/>]</pre> | no |
| <a name="input_bgsi_team_developer"></a> [bgsi\_team\_developer](#input\_bgsi\_team\_developer) | BGSI Developer Team Member | `list(any)` | <pre>[<br/>  "bgsi.developer01@binomika.kemkes.go.id",<br/>  "bgsi.developer02@binomika.kemkes.go.id",<br/>  "bgsi.developer03@binomika.kemkes.go.id"<br/>]</pre> | no |
...
| <a name="input_kms_key"></a> [kms\_key](#input\_kms\_key) | KMS Key References | `map(string)` | <pre>{<br/>  "default": "arn:aws:kms:ap-southeast-3:136839993415:key/HASH_KEY_NUMBER",<br/>  "lab": "arn:aws:kms:ap-southeast-3:136839993415:key/HASH_KEY_NUMBER",<br/>  "prod": "arn:aws:kms:ap-southeast-3:136839993415:key/HASH_KEY_NUMBER",<br/>  "staging": "arn:aws:kms:ap-southeast-3:136839993415:key/HASH_KEY_NUMBER"<br/>}</pre> | no |
...
| <a name="input_tf_user_executor"></a> [tf\_user\_executor](#input\_tf\_user\_executor) | TF User Executor | `string` | `"TF-User-Executor-136839993415"` | no |
...
| <a name="output_gxc_developer_policy"></a> [gxc\_developer\_policy](#output\_gxc\_developer\_policy) | BGSI Developer Policy Name |
