...
| <a name="input_bgsi_team_administrator"></a> [bgsi\_team\_administrator](#input\_bgsi\_team\_administrator) | BGSI Administrator Team Member | `list(any)` | <pre>[<br/>  "yatish.jain@bgsi.au"<br/>]</pre> | no |
| <a name="input_bgsi_team_developer"></a> [bgsi\_team\_developer](#input\_bgsi\_team\_developer) | BGSI Developer Team Member | `list(any)` | <pre>[<br/>  "anuradha.wickramarachchi@bgsi.au",<br/>  "nick.edwards@bgsi.au",<br/>  "brendan.hosking@bgsi.au",<br/>  "mitchell.obrien@bgsi.au"<br/>]</pre> | no |
