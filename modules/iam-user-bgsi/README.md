...
| <a name="input_bgsi_team_administrator"></a> [bgsi\_team\_administrator](#input\_bgsi\_team\_administrator) | BGSI Administrator Team Member | `list(any)` | n/a | yes |
| <a name="input_bgsi_team_developer"></a> [bgsi\_team\_developer](#input\_bgsi\_team\_developer) | BGSI Developer Team Member | `list(any)` | n/a | yes |
