...
#  Identity Policy
# --------------------------------------------------------------------------
resource "aws_iam_policy" "gxc_developer_policy" {
  provider    = aws.destination
  name        = "${var.policy_gxc_developer}_${var.aws_account_id_destination}_${var.workspace_env[local.env]}"
  path        = "/"
  description = "GXC Policy for Developer"
...
resource "aws_iam_policy" "gxc_poweruser_acess" {
  provider    = aws.destination
  name        = "gxc-poweruseraccess_${var.aws_account_id_destination}_${var.workspace_env[local.env]}"
  path        = "/"
  description = "GXC Policy for PowerUser Access"
...
resource "aws_iam_policy" "gxc_iamfull_acess" {
  provider    = aws.destination
  name        = "gxc-iamfullaccess_${var.aws_account_id_destination}_${var.workspace_env[local.env]}"
  path        = "/"
  description = "GXC Policy for IAMFull Access"
...
resource "aws_iam_group_policy_attachment" "policy_iamfull_access" {
  provider   = aws.destination
  policy_arn = aws_iam_policy.gxc_iamfull_acess.arn
