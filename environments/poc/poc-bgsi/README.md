...
| <a name="input_aws_account_id"></a> [aws\_account\_id](#input\_aws\_account\_id) | The AWS Account ID | `string` | `"442799077487"` | no |
| <a name="input_aws_account_profile"></a> [aws\_account\_profile](#input\_aws\_account\_profile) | The AWS Profile | `string` | `"BGSI-TF-User-Executor-RSCM"` | no |
...
| <a name="input_kms_key"></a> [kms\_key](#input\_kms\_key) | KMS Key References | `map(string)` | <pre>{<br/>  "default": "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_NUMBER",<br/>  "lab": "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_NUMBER",<br/>  "nonprod": "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_NUMBER",<br/>  "prod": "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_NUMBER",<br/>  "staging": "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_NUMBER"<br/>}</pre> | no |
