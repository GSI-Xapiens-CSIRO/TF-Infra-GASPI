# ==========================================================================
#  442799077487 - IAM TFUser-Executor: variable.tf
# --------------------------------------------------------------------------
#  Description:
#    Global Variable
# --------------------------------------------------------------------------
...
variable "kms_key" {
  ...
  default = {
    default = "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_KEY_NUMBER"
    lab     = "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_KEY_NUMBER"
    staging = "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_KEY_NUMBER"
    prod    = "arn:aws:kms:ap-southeast-3:442799077487:key/HASH_KEY_NUMBER"
  }
}
