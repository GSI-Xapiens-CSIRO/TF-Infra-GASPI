# ==========================================================================
#  123412341234 - TFState: variable.tf
# --------------------------------------------------------------------------
#  Description:
#    Global Variable
# --------------------------------------------------------------------------
...
variable "kms_key" {
  ...
  default = {
    default = "arn:aws:kms:ap-southeast-3:123412341234:key/HASH_NUMBER"
    lab     = "arn:aws:kms:ap-southeast-3:123412341234:key/HASH_NUMBER"
    staging = "arn:aws:kms:ap-southeast-3:123412341234:key/HASH_NUMBER"
    prod    = "arn:aws:kms:ap-southeast-3:123412341234:key/HASH_NUMBER"
  }
}
...
variable "aws_account_profile_source" {
  ...
  type        = string
  default     = "GXC-TF-User-Executor-UAT05"
}
...
variable "tfstate_bucket" {
  ...
  type        = string
  default     = "tf-state-123412341234-ap-southeast-3"
}

variable "tfstate_dynamodb_table" {
  description = "Name of dynamodb table to store tfstate"
  type        = string
  default     = "ddb-tf-state-123412341234-ap-southeast-3"
}
