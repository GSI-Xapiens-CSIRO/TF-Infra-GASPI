...
| <a name="input_aws_account_id"></a> [aws\_account\_id](#input\_aws\_account\_id) | The AWS Account ID | `string` | `"460722568061"` | no |
...
| <a name="input_kms_key"></a> [kms\_key](#input\_kms\_key) | KMS Key References | `map(string)` | <pre>{<br/>  "default": "arn:aws:kms:ap-southeast-3:460722568061:key/HASH_NUMBER",<br/>  "lab": "arn:aws:kms:ap-southeast-3:460722568061:key/HASH_NUMBER",<br/>  "nonprod": "arn:aws:kms:ap-southeast-3:460722568061:key/HASH_NUMBER",<br/>  "prod": "arn:aws:kms:ap-southeast-3:460722568061:key/HASH_NUMBER",<br/>  "staging": "arn:aws:kms:ap-southeast-3:460722568061:key/HASH_NUMBER"<br/>}</pre> | no |
