...
cat > trust-policy.json << 'EOF'
{
  ...
  "Statement": [
    ...
    },
    {
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:sts::480756163420:assumed-role/cp-sts-grant-role/swift-ap-southeast-3-prod-209479276142"
      },
      "Action": "sts:AssumeRole"
    },
    {
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::209479276142:root"
      },
      "Action": "sts:AssumeRole"
    }
  ]
  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:s3:::genomic-snapshot-209479276142"
    },
    {
      "Effect": "Allow",
      "Action": [
