...
export CI_PROJECT_REGISTRY_ECR="$AWS_ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/gxc/devops"
export CI_PROJECT_PATH="devopsxti"
export CI_PROJECT_NAME="atlantis-gxc"
