# ==========================================================================
#  695094375681 - TFState: variable.tf
# --------------------------------------------------------------------------
#  Description:
#    Global Variable
# --------------------------------------------------------------------------
...
variable "kms_key" {
  ...
  default = {
    default = "arn:aws:kms:ap-southeast-3:695094375681:key/HASH_KEY_NUMBER"
    lab     = "arn:aws:kms:ap-southeast-3:695094375681:key/HASH_KEY_NUMBER"
    staging = "arn:aws:kms:ap-southeast-3:695094375681:key/HASH_KEY_NUMBER"
    prod    = "arn:aws:kms:ap-southeast-3:695094375681:key/HASH_KEY_NUMBER"
  }
}
...
variable "aws_account_profile_source" {
  ...
  type        = string
  default     = "BGSI-TF-User-Executor-RSCM-UAT"
}
...
variable "tfstate_bucket" {
  ...
  type        = string
  default     = "tf-state-695094375681-ap-southeast-3"
}

variable "tfstate_dynamodb_table" {
  description = "Name of dynamodb table to store tfstate"
  type        = string
  default     = "ddb-tf-state-695094375681-ap-southeast-3"
}
